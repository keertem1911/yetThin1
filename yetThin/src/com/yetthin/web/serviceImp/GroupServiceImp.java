...
//		int i =groupMapper.saveRecommend(map);
	 ...
	 */
	@Override
	public String addRecommend(RecommendInfo info) {
		// TODO Auto-generated method stub
		info.setCreateTime(simple.format(new Date()));
//		int i = groupMapper.insertRecommend(info);
		int i =2;
		String status = i!=0?"200":"500";
	 ...
	 */
	@Override
	public String deleteRecommend(String id) {
		// TODO Auto-generated method stub
//		int i = groupMapper.deleteRecommend(id);
		int i=2;
		String status = i!=0?"200":"500";
		return "{\"status\":\""+status+"\"}";
	}
